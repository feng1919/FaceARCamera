...
extern NSString *const kGPUImageRGBErosionRadiusOneFragmentShaderString;
extern NSString *const kGPUImageRGBErosionRadiusTwoFragmentShaderString;
extern NSString *const kGPUImageRGBErosionRadiusThreeFragmentShaderString;
extern NSString *const kGPUImageRGBErosionRadiusFourFragmentShaderString;
