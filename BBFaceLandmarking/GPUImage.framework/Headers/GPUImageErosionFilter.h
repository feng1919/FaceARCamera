...
extern NSString *const kGPUImageErosionRadiusOneFragmentShaderString;
extern NSString *const kGPUImageErosionRadiusTwoFragmentShaderString;
extern NSString *const kGPUImageErosionRadiusThreeFragmentShaderString;
extern NSString *const kGPUImageErosionRadiusFourFragmentShaderString;
