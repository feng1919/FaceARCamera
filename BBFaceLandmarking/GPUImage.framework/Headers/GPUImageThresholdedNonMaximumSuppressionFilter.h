...
extern NSString *const kGPUImageThresholdedNonMaximumSuppressionFragmentShaderString;
extern NSString *const kGPUImageThresholdedNonMaximumSuppressionPackedColorspaceFragmentShaderString;
