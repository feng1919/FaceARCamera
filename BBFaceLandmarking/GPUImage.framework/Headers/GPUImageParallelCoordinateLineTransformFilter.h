...
extern NSString *const kGPUImageHoughAccumulationVertexShaderString;
extern NSString *const kGPUImageHoughAccumulationFragmentShaderString;
extern NSString *const kGPUImageHoughAccumulationFBOReadFragmentShaderString;
