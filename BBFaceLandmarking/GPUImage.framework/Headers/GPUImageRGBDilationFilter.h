...
extern NSString *const kGPUImageRGBDilationRadiusOneFragmentShaderString;
extern NSString *const kGPUImageRGBDilationRadiusTwoFragmentShaderString;
extern NSString *const kGPUImageRGBDilationRadiusThreeFragmentShaderString;
extern NSString *const kGPUImageRGBDilationRadiusFourFragmentShaderString;
